...
var isPosNumber = validate_1.isPosNumber,
    mergeArgumentsIsNumber = validate_1.mergeArgumentsIsNumber;
var utils = {
  /**
   * 初始化参数
...
var mergeArgumentsIsNumber$1 = validate_1.mergeArgumentsIsNumber;
var mergeOptions = utils_1.mergeOptions,
    getChainParams = utils_1.getChainParams,
    packResult$1 = utils_1.packResult;
var _add = core._add,
    _mul = core._mul,
    _div = core._div,
    _total = core._total;
...
function Calc(options) {
  ...
  this.val = function () {
    ...
    return packResult$1(this._chain.getChainRes(), _options);
  };
...
Calc.prototype.add = function (a, b) {
  ...
  var _arguments = mergeArgumentsIsNumber$1(Array.prototype.slice.call(arguments));
...
Calc.prototype.sub = function (a, b) {
  ...
  var _arguments = mergeArgumentsIsNumber$1(Array.prototype.slice.call(arguments)); // 减法相当于加上b的负数
...
Calc.prototype.adds = function (arr) {
  ...
  var _arguments = mergeArgumentsIsNumber$1(arr, true);
...
function chain(initNumber) {
  var _arguments = mergeArgumentsIsNumber$1([initNumber, 0.01]);
