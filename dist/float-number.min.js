...
var validate = {
  // 校验参数是否为数字
  mergeArgumentsIsNumber: function mergeArgumentsIsNumber(arr) {
    var _arr = []; // const len = arr.length === 3 ? 2 : 2
